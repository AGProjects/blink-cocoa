...
"pstn.asserted_identity" : StringOption,
...
SettingDescription = {
                      ...
                      'file_transfer.send_media_as_original': NSLocalizedString("Send Pictures and Movies at Original Size", "Label"),
                      ...
                      'pstn.asserted_identity': NSLocalizedString("Asserted Identity", "Label"),
...
GeneralSettingsOrder = {
                       ...
                       'chat': ['disabled', 'enable_msrp_chat'],
                       'video': ['device', 'container', 'quality', 'resolution', 'framerate', 'max_bitrate'],
                       'file_transfer': ['disabled', 'auto_accept', 'send_media_as_original', 'render_incoming_image_in_chat_window', 'render_incoming_video_in_chat_window', 'directory'],
...
BonjourAccountSectionOrder = ('audio', 'sounds', 'tls', 'msrp', 'rtp', 'sip', 'presence', 'ldap', 'sms', 'conference')
...
ToolTips = {
             ...
             'sip.tls_name': NSLocalizedString("Server must present an X.509 certificate with this name, otherwise the domain name", "Label"),
