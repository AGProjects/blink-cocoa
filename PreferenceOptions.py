...
SectionNames = {
                       ...
                       'gui': 'GUI Settings',
                       'logs': 'File Logging',
                       'message_summary': 'Voicemail Subscriptions',
                       'msrp': 'MSRP Media',
...
AccountSectionOrder = ('auth', 'audio', 'sounds', 'chat', 'sms', 'conference', 'web_alert', 'pstn', 'tls', 'sip', 'rtp', 'msrp', 'xcap', 'message_summary', 'nat_traversal','server', 'ldap')
