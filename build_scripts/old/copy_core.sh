...
for p in pkg_resources six greenlet sipsimple msrplib xcaplib eventlib gnutls application otr twisted zope certifi cffi pgpy pyasn1 pytz sqlobject dns formencode gevent service_identity lxml dateutil pydispatch gmpy2 ldap3; do
