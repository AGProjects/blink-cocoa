...
for p in greenlet sipsimple msrplib xcaplib eventlib gnutls application otr twisted zope certifi cffi pgpy pyasn1 pytz sqlobject dns formencode gevent; do
