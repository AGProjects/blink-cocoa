...
PresenceStatusList = [(1, u"Available",       {'name': "Available",      'basic_status': 'open',   'extended_status': 'available',     'rpid_activity': 'available', 'image': 'status-user-available-icon', 'note': 'I am available'}),
                      (-1, u"Away",           {'name': "Away",           'basic_status': 'open',   'extended_status': 'away',          'rpid_activity': 'away', 'image': 'status-user-away-icon', 'note': 'I am away at the moment'}),
    (-1, u"On the Phone",   {'name': "On the Phone",   'basic_status': 'open',   'extended_status': 'busy',          'rpid_activity': 'on-the-phone', 'image': 'status-user-phone-icon', 'note': 'I am in phone call now'}),
    ...
    (-1, u"Travel",         {'name': "Travel",         'basic_status': 'open',   'extended_status': 'extended-away', 'rpid_activity': 'travel', 'image': 'status-user-travel-icon', 'note': 'I am traveling now'}),
    (-1, u"Vacation",       {'name': "Vacation",       'basic_status': 'open',   'extended_status': 'extended-away', 'rpid_activity': 'vacation', 'image': 'status-user-vacation-icon', 'note': 'I am in vacantion for awhile'}),
