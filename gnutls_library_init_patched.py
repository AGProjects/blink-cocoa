...
#   /Applications/Blink Pro.app/Contents/Resources/lib/gnutls/library/__init__.py
#
# Rename this file to __init__.py before copying. Tell the user to launch
# Blink Pro from Terminal so they can see the log lines:
#   /Applications/Blink\ Pro.app/Contents/MacOS/Blink\ Pro 2>&1 | grep python-gnutls
# or check Console.app and filter on "python-gnutls" — the line is written
# to stderr, which Blink's stderr filter forwards to the system log.
