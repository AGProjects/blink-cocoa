...
def setup(delegate):
    ...
    delegate.sp_update_url = "https://blink.sipthor.net/ElQuijoteAppcast.xml"
    ...
    delegate.account_extension = AccountExtensionELQuijote
    delegate.about_image = 'ElQuijote-logo'
    ...
    delegate.statusbar_menu_icon = 'ElQuijote'
